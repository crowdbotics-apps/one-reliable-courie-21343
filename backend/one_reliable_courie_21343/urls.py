"""one_reliable_courie_21343 URL Configuration
...
admin.site.site_header = "One Reliable Courier"
admin.site.site_title = "One Reliable Courier Admin Portal"
admin.site.index_title = "One Reliable Courier Admin"

# swagger
api_info = openapi.Info(
    title="One Reliable Courier API",
    default_version="v1",
    description="API documentation for One Reliable Courier App",
)
